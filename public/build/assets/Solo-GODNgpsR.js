import{K as We,r as i,j as e,L as Je}from"./app-BZCKzOWh.js";import{b as m,a as w,A as Qe,T as re,C as Ke}from"./app-layout-CdO7mqVt.js";import{S as f}from"./sweetalert2.esm.all-acGi8jXx.js";import{A as Ve}from"./AnimatedBackground-7HcrXn6C.js";import{C as le}from"./crown-CoAUN9_e.js";import{S as we}from"./sparkles-Cc-MSFZo.js";import{T as je}from"./trophy-D7CzQ6O5.js";import{C as Ze}from"./circle-check-big-0X5yhCqx.js";import{S as et}from"./search-DURZCrXc.js";import{R as Ne}from"./refresh-cw-D-q3nLz8.js";import{L as _e}from"./lightbulb-ByEtJmhr.js";import{P as tt}from"./play-DB_HuRY-.js";import{B as at}from"./x-CJR1Bkb0.js";import{S as st}from"./send-CMf_IaVt.js";import{T as rt}from"./triangle-alert-CX22As8J.js";import{Z as lt}from"./zap-CVGAB3zw.js";import"./utils-jAU0Cazi.js";import"./createLucideIcon-Ccq_IMoE.js";import"./users-BStg1wDH.js";const ot=[{title:"Home",href:"/dashboard"},{title:"Practice",href:"#"},{title:"Solo Challenge",href:"/play/solo"}],x={panelClass:"rounded-xl border",panelStyle:{background:"var(--panel-bg, rgba(17,24,39,0.50))",borderColor:"var(--panel-border, rgba(75,85,99,0.50))",backdropFilter:"blur(6px)"},chipClass:"px-2 py-1 text-xs font-semibold rounded-full border",chipBlueStyle:{background:"var(--chip-blue-bg, rgba(30,58,138,0.30))",borderColor:"var(--chip-blue-border, rgba(59,130,246,0.50))",color:"var(--chip-blue-text, #93c5fd)"},chipEasyStyle:{background:"var(--chip-easy-bg, rgba(6,78,59,0.30))",borderColor:"var(--chip-easy-border, rgba(16,185,129,0.50))",color:"var(--chip-easy-text, #86efac)"},chipMedStyle:{background:"var(--chip-med-bg, rgba(113,63,18,0.30))",borderColor:"var(--chip-med-border, rgba(234,179,8,0.50))",color:"var(--chip-med-text, #fde68a)"},chipHardStyle:{background:"var(--chip-hard-bg, rgba(127,29,29,0.30))",borderColor:"var(--chip-hard-border, rgba(248,113,113,0.50))",color:"var(--chip-hard-text, #fca5a5)"},btnPrimaryClass:"rounded-lg shadow-lg hover:scale-110 transition-all duration-300",btnPrimaryStyle:{background:"var(--btn-primary, linear-gradient(90deg,#06b6d4,#2563eb))",color:"var(--btn-primary-text, #fff)"}},nt={python:"Python",java:"Java",cpp:"C++"},ke=v=>nt[v]??v.toUpperCase();function Lt(){const{auth:v}=We().props;v==null||v.user;const[oe,ne]=i.useState([]),[c,q]=i.useState(null),[Ce,ie]=i.useState(!0),[it,ce]=i.useState(!0),[X,ct]=i.useState("all"),[C,Se]=i.useState("all"),[S,Ee]=i.useState("all"),[E,Ae]=i.useState(""),[r,Y]=i.useState(null),[j,D]=i.useState(!1),[g,A]=i.useState(""),[L,O]=i.useState(!1),[b,B]=i.useState(0),[R,H]=i.useState(null),[F,G]=i.useState(!1),[h,W]=i.useState(null),[dt,J]=i.useState(!1),[P,de]=i.useState([]),[Le,Q]=i.useState(!1),[Be,K]=i.useState(!1),[Fe,me]=i.useState(!1),[Pe,V]=i.useState(!1),[Te,Z]=i.useState(!1),[Me,pe]=i.useState(!1),T=i.useRef(),[Ie,ue]=i.useState({});i.useEffect(()=>{j?document.body.classList.add("modal-open"):document.body.classList.remove("modal-open")},[j]),i.useEffect(()=>{m.registerSfx("success","/sounds/correct.mp3"),m.registerSfx("failure","/sounds/failure.mp3"),m.registerSfx("levelup","/sounds/levelup.mp3"),m.registerSfx("click","/sounds/click.mp3"),m.registerSfx("hover","/sounds/hover.mp3"),m.registerSfx("victory","/sounds/victory.mp3"),m.registerSfx("streak","/sounds/streak.mp3"),m.registerSfx("typing","/sounds/typing.mp3")},[]);const ee=t=>Math.floor(t/10)+1,te=t=>10-t%10,xe=t=>t%10/10*100,fe=t=>t%10;i.useEffect(()=>{I(),$(),M()},[X,C,S,E]),i.useEffect(()=>{const t=!!(j&&r);try{window.__modalOpen=t,window.dispatchEvent(new CustomEvent("app:modal",{detail:{open:t}}))}catch{}const s=document.documentElement;return t?s.classList.add("overflow-hidden"):s.classList.remove("overflow-hidden"),()=>s.classList.remove("overflow-hidden")},[j,r]),i.useEffect(()=>{let t;return R&&(t=setInterval(()=>{B(Math.floor((Date.now()-R.getTime())/1e3))},1e3)),()=>{t&&clearInterval(t)}},[R]),i.useEffect(()=>{if(P.length>0){const t=()=>{de(s=>s.map(a=>({...a,x:a.x+a.vx,y:a.y+a.vy,vy:a.vy-.15,life:a.life-1,size:a.size*.99})).filter(a=>a.life>0)),P.length>0&&(T.current=requestAnimationFrame(t))};T.current=requestAnimationFrame(t)}return()=>{T.current&&cancelAnimationFrame(T.current)}},[P.length]);const M=async()=>{try{const t=await w.get("/api/solo/taken");if(t.success){const s=(t.data||[]).reduce((a,n)=>(a[n.challenge_id]=n.status,a),{});ue(s)}}catch(t){console.error("Error fetching taken rows:",t),ue({})}},I=async()=>{try{ie(!0);const t={};X!=="all"&&(t.mode=X),C!=="all"&&(t.language=C),S!=="all"&&(t.difficulty=S),E.trim()&&(t.search=E.trim());const s=await w.get("/api/challenges/solo",t);if(s.success){const a=s.data.data||s.data||[];ne(a)}}catch(t){console.error("Error fetching challenges:",t),ne([])}finally{ie(!1)}},$=async()=>{var t,s,a;try{ce(!0);const n=await w.get("/api/me/stats");if(n.success&&n.data){const l=n.data,p=((t=l.totals)==null?void 0:t.xp)||0;let o=[];if(l.completed_challenge_ids&&Array.isArray(l.completed_challenge_ids))o=l.completed_challenge_ids;else if((s=l.solo_stats)!=null&&s.completed_challenge_ids)o=l.solo_stats.completed_challenge_ids;else if(l.attempts){const d=l.attempts.filter(u=>u.is_correct);o=[...new Set(d.map(u=>u.challenge_id))]}else{const d=["completed_challenges","solo_completed_challenges","successful_challenge_ids","completed_solo_challenges"];for(const u of d)if(l[u]&&Array.isArray(l[u])){o=l[u],console.log(`Found completed challenges in field: ${u}`);break}}q({solo_attempts:l.solo_attempts||0,successful_attempts:l.successful_attempts||o.length,total_xp:p,total_stars:((a=l.totals)==null?void 0:a.stars)||0,attempts_today:l.attempts_today||0,current_level:ee(p),xp_to_next_level:te(p),completed_challenge_ids:o,streak:l.streak||0})}}catch(n){console.error("Error fetching user stats:",n),q({solo_attempts:0,successful_attempts:0,total_xp:0,total_stars:0,attempts_today:0,current_level:1,xp_to_next_level:10,completed_challenge_ids:[],streak:0})}finally{ce(!1)}},ge=(t,s,a="success")=>{const n={success:["#10B981","#34D399","#6EE7B7","#FBBF24","#F59E0B"],levelup:["#8B5CF6","#A78BFA","#C4B5FD","#F59E0B","#FBBF24"],streak:["#EF4444","#F87171","#FCA5A5","#FBBF24","#F59E0B"]},l=[],p=a==="levelup"?25:15;for(let o=0;o<p;o++){const d=Math.PI*2*o/p,u=Math.random()*8+4;l.push({id:Date.now()+o,x:t+(Math.random()-.5)*50,y:s+(Math.random()-.5)*30,vx:Math.cos(d)*u+(Math.random()-.5)*2,vy:Math.sin(d)*u-Math.random()*3,life:80+Math.random()*40,maxLife:80,color:n[a][Math.floor(Math.random()*n[a].length)],size:Math.random()*6+3,type:a})}de(o=>[...o,...l])},$e=()=>{const t=document.documentElement;t.requestFullscreen?t.requestFullscreen():t.webkitRequestFullscreen?t.webkitRequestFullscreen():t.msRequestFullscreen&&t.msRequestFullscreen()},ze=()=>{var t;document.fullscreenElement&&((t=document.exitFullscreen)==null||t.call(document))},Ue=t=>{if(m.play("click"),$e(),c!=null&&c.completed_challenge_ids.includes(t.id)){m.play("failure"),f.fire({icon:"info",title:"Challenge Already Completed!",text:"You have already solved this challenge. Try a different one!",timer:2e3,showConfirmButton:!1,background:"#1f2937",color:"#fff"});return}Y(t),A(t.buggy_code||""),D(!0),H(new Date),B(0)},he=(t,s)=>{const a=t.length,n=s.length;if(a===0)return n===0?1:0;if(n===0)return 0;const l=Array(n+1).fill(null).map(()=>Array(a+1).fill(null));for(let o=0;o<=a;o++)l[0][o]=o;for(let o=0;o<=n;o++)l[o][0]=o;for(let o=1;o<=n;o++)for(let d=1;d<=a;d++)t[d-1]===s[o-1]?l[o][d]=l[o-1][d-1]:l[o][d]=Math.min(l[o-1][d]+1,l[o][d-1]+1,l[o-1][d-1]+1);const p=Math.max(a,n);return(p-l[n][a])/p},qe=(t,s)=>{var _,k;const a=t.trim(),n=(_=s.fixed_code)==null?void 0:_.trim();if(!a)return console.log("Code validation: FAIL - No code provided"),!1;if(!n)return console.log("Code validation: FAIL - No solution available in database"),!1;if(a===((k=s.buggy_code)==null?void 0:k.trim()))return console.log("Code validation: FAIL - No changes made from original buggy code"),!1;const l=se=>se.replace(/\r\n/g,`
`).replace(/\s+/g," ").replace(/\s*;\s*/g,";").replace(/\s*\{\s*/g,"{").replace(/\s*\}\s*/g,"}").replace(/\s*\(\s*/g,"(").replace(/\s*\)\s*/g,")").replace(/\s*==\s*/g,"==").replace(/\s*=\s*/g,"=").trim(),p=l(a),o=l(n);if(p===o)return console.log("Code validation: PASS - Exact match with database solution (100%)"),!0;const u=he(p,o),y=Math.round(u*100);console.log(`Code validation: FAIL - Only ${y}% similarity with database solution (requires 100%)`);const N=u>=1;return console.log(`Code validation: ${N?"PASS":"FAIL"} (${y}% similarity, requires 100%)`),N},Xe=async()=>{var t;if(!r||!g.trim()){m.play("failure"),f.fire("Error","Please write some code before submitting.","error");return}try{if(O(!0),m.play("typing"),!r.fixed_code){m.play("failure"),f.fire("Error","This challenge does not have a solution stored in the database.","error"),O(!1);return}const s=qe(g,r),a=he(g.trim().replace(/\s+/g," "),r.fixed_code.trim().replace(/\s+/g," "));W({isCorrect:s,similarity:a}),G(!0);const n={challenge_id:r.id,language:r.language,mode:r.mode,time_spent_sec:b,is_correct:s,code_submitted:g,judge_feedback:s?"Perfect! Your solution is an exact match with the expected answer from database (100% match).":`Incorrect. Your solution has ${Math.round(a*100)}% similarity with the expected answer. You need 100% match to pass. Try again or view the correct answer.`},l=await w.post("/api/solo/attempts",n);if(l.success){const p=((t=l.data)==null?void 0:t.xp_earned)||(s?r.reward_xp:0);if(s){await w.post("/api/solo/mark-taken",{challenge_id:r.id,language:r.language,difficulty:r.difficulty,mode:r.mode,status:"completed",time_spent_sec:b,code_submitted:g,earned_xp:p??0});const o=(c==null?void 0:c.total_xp)||0,d=o+p,u=ee(o),y=ee(d),N=y>u;c&&!c.completed_challenge_ids.includes(r.id)&&q(U=>U?{...U,completed_challenge_ids:[...U.completed_challenge_ids,r.id],successful_attempts:U.successful_attempts+1,total_xp:d,current_level:y,xp_to_next_level:te(d)}:null),m.play("success"),K(!0),V(!0),Z(!0),pe(!0),setTimeout(()=>pe(!1),2e3);const _=window.innerWidth/2,k=window.innerHeight/2;ge(_,k,"success"),N&&setTimeout(()=>{m.play("levelup"),Q(!0),ge(_,k-100,"levelup")},1e3),setTimeout(()=>{m.play("victory")},500);const{isConfirmed:se}=await f.fire({title:"PERFECT SOLUTION!",html:`
    <div class="text-center">
      ...
      <div class="grid grid-cols-2 gap-4 mb-4">
        <div class="bg-gray-900/40 rounded-lg p-3">
          <div class="text-lg font-bold text-amber-300">+${p??3}</div>
      ...
      <div class="text-sm text-gray-300">
        ⏱️ Completed in ${Math.floor(b/60)}m ${b%60}s
      </div>
  ...
  `,showConfirmButton:!0,confirmButtonText:"Continue Coding!",confirmButtonColor:"#CA8A04",background:"linear-gradient(160deg, #0f172a 0%, #422006 35%, #854d0e 100%)",color:"#fefce8",backdrop:"rgba(0,0,0,0.6)",allowOutsideClick:!1,allowEscapeKey:!1});se&&(K(!1),V(!1),Q(!1),Z(!1),D(!1),Y(null),A(""),H(null),B(0),G(!1),W(null),J(!1),await Promise.all([I(),$(),M()])),setTimeout(()=>{K(!1),V(!1),Q(!1),Z(!1)},7e3)}else m.play("failure"),me(!0),setTimeout(()=>me(!1),600),await f.fire({title:"Almost There!",html:`
                            <div class="text-center">
                        ...
                        `,timer:4500,showConfirmButton:!0,confirmButtonText:"Try Again",background:"linear-gradient(160deg, #0f172a 0%, #1e293b 50%, #111827 100%)",color:"#e5e7eb",confirmButtonColor:"#3B82F6",backdrop:"rgba(0,0,0,0.6)"});await Promise.all([$(),I()]),await M()}else throw new Error(l.message||"Submission failed")}catch(s){console.error("Error submitting attempt:",s),m.play("failure");let a="Failed to submit your attempt. Please try again.";s instanceof Error&&(a=s.message),f.fire("Error",a,"error")}finally{O(!1)}},be=async t=>{try{if(r){const s={challenge_id:r.id,language:r.language,difficulty:r.difficulty,mode:r.mode,status:t,time_spent_sec:b,code_submitted:g||r.buggy_code||"",earned_xp:t==="completed"?r.reward_xp??0:0};await w.post("/api/solo/mark-taken",s),console.log(`Challenge marked as ${t} in database`)}}catch(s){console.error("Error marking challenge as taken:",s),f.fire({title:"Warning",text:"Progress may not have been saved properly.",icon:"warning",timer:1500,showConfirmButton:!1,background:"#1f2937",color:"#fff"})}finally{m.play("click"),D(!1),Y(null),A(""),H(null),B(0),G(!1),W(null),J(!1),ze(),await I(),await $(),await M()}},Ye=async()=>{try{if(!r)return;const t=r.fixed_code;r&&g.trim()!==(r.buggy_code??"").trim()||b>0?await be("abandoned"):await be("abandoned"),t&&t.trim().length>0?ve("Correct Answer",t):f.fire({icon:"info",title:"No Stored Solution",text:"This challenge has no fixed solution saved in the database.",background:"#1f2937",color:"#fff",confirmButtonColor:"#10B981"})}catch(t){console.error("quitAndShowSolution error:",t)}},De=()=>{r!=null&&r.fixed_code&&(m.play("click"),J(!0),ve("Correct Answer",r.fixed_code),f.fire({title:"Correct Answer",html:`
    ...
    `,showCancelButton:!0,confirmButtonText:"Show Answer",cancelButtonText:"Cancel",background:"#0f172a",color:"#f8fafc",confirmButtonColor:"#ef4444",cancelButtonColor:"#6b7280",width:600,customClass:{popup:"rounded-xl border border-slate-700 shadow-2xl backdrop-blur-sm",title:"p-0",htmlContainer:"p-0",confirmButton:"px-5 py-2 rounded-lg font-semibold",cancelButton:"px-5 py-2 rounded-lg font-semibold"},didOpen:()=>{const n=document.querySelector(".swal2-icon");n&&n.remove()}})).isConfirmed&&await f.fire({title:`
      <div class="text-center">
    ...
    `,html:`
      <div class="bg-slate-900 border border-slate-700 rounded-xl p-5 shadow-lg text-left">
        <div class="mb-3 flex items-center justify-between border-b border-slate-700 pb-2">
          <span class="text-yellow-400 font-semibold">🏆 ${t}</span>
