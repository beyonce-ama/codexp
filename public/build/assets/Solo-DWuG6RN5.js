import{K as We,r as n,j as e,L as Je}from"./app-DvCe9KXz.js";import{b as d,a as w,A as Ke,T as re,C as Qe}from"./app-layout-6Zzl_KyH.js";import{S as f}from"./sweetalert2.esm.all-acGi8jXx.js";import{A as Ve}from"./AnimatedBackground-BheVB-ED.js";import{C as le}from"./crown--xMlcTqZ.js";import{S as ye}from"./sparkles-BahuoOyB.js";import{T as ve}from"./trophy-OTPQqAMk.js";import{C as Ze}from"./circle-check-big-BBuD5bBS.js";import{S as et}from"./search-DYOVm3eh.js";import{R as we}from"./refresh-cw-DogzShY-.js";import{L as je}from"./lightbulb-B_ZsUZcm.js";import{P as tt}from"./play-cm3nV6uU.js";import{X as st,B as at}from"./x-DIjYbKdQ.js";import{S as rt}from"./send-B2GSKbYa.js";import{T as lt}from"./triangle-alert-Cmth9lpR.js";import{Z as ot}from"./zap-cKhPGjkX.js";import"./utils-jAU0Cazi.js";import"./createLucideIcon-CFhvdAWv.js";import"./users-DmJxt5-l.js";const nt=[{title:"Home",href:"/dashboard"},{title:"Practice",href:"#"},{title:"Solo Challenge",href:"/play/solo"}],x={panelClass:"rounded-xl border",panelStyle:{background:"var(--panel-bg, rgba(17,24,39,0.50))",borderColor:"var(--panel-border, rgba(75,85,99,0.50))",backdropFilter:"blur(6px)"},chipClass:"px-2 py-1 text-xs font-semibold rounded-full border",chipBlueStyle:{background:"var(--chip-blue-bg, rgba(30,58,138,0.30))",borderColor:"var(--chip-blue-border, rgba(59,130,246,0.50))",color:"var(--chip-blue-text, #93c5fd)"},chipEasyStyle:{background:"var(--chip-easy-bg, rgba(6,78,59,0.30))",borderColor:"var(--chip-easy-border, rgba(16,185,129,0.50))",color:"var(--chip-easy-text, #86efac)"},chipMedStyle:{background:"var(--chip-med-bg, rgba(113,63,18,0.30))",borderColor:"var(--chip-med-border, rgba(234,179,8,0.50))",color:"var(--chip-med-text, #fde68a)"},chipHardStyle:{background:"var(--chip-hard-bg, rgba(127,29,29,0.30))",borderColor:"var(--chip-hard-border, rgba(248,113,113,0.50))",color:"var(--chip-hard-text, #fca5a5)"},btnPrimaryClass:"rounded-lg shadow-lg hover:scale-110 transition-all duration-300",btnPrimaryStyle:{background:"var(--btn-primary, linear-gradient(90deg,#06b6d4,#2563eb))",color:"var(--btn-primary-text, #fff)"}},it={python:"Python",java:"Java",cpp:"C++"},Ne=y=>it[y]??y.toUpperCase();function Bt(){const{auth:y}=We().props;y==null||y.user;const[oe,ne]=n.useState([]),[c,U]=n.useState(null),[ke,ie]=n.useState(!0),[ct,ce]=n.useState(!0),[q,dt]=n.useState("all"),[C,_e]=n.useState("all"),[S,Ce]=n.useState("all"),[A,Se]=n.useState(""),[r,Y]=n.useState(null),[j,O]=n.useState(!1),[h,E]=n.useState(""),[L,D]=n.useState(!1),[v,B]=n.useState(0),[R,H]=n.useState(null),[F,G]=n.useState(!1),[g,W]=n.useState(null),[mt,J]=n.useState(!1),[P,de]=n.useState([]),[Ae,K]=n.useState(!1),[Ee,Q]=n.useState(!1),[Le,me]=n.useState(!1),[Be,V]=n.useState(!1),[Fe,Z]=n.useState(!1),[Pe,pe]=n.useState(!1),T=n.useRef(),[Te,ue]=n.useState({});n.useEffect(()=>{j?document.body.classList.add("modal-open"):document.body.classList.remove("modal-open")},[j]),n.useEffect(()=>{d.registerSfx("success","/sounds/correct.mp3"),d.registerSfx("failure","/sounds/failure.mp3"),d.registerSfx("levelup","/sounds/levelup.mp3"),d.registerSfx("click","/sounds/click.mp3"),d.registerSfx("hover","/sounds/hover.mp3"),d.registerSfx("victory","/sounds/victory.mp3"),d.registerSfx("streak","/sounds/streak.mp3"),d.registerSfx("typing","/sounds/typing.mp3")},[]);const ee=t=>Math.floor(t/10)+1,te=t=>10-t%10,xe=t=>t%10/10*100,fe=t=>t%10;n.useEffect(()=>{I(),$(),M()},[q,C,S,A]),n.useEffect(()=>{const t=!!(j&&r);try{window.__modalOpen=t,window.dispatchEvent(new CustomEvent("app:modal",{detail:{open:t}}))}catch{}const a=document.documentElement;return t?a.classList.add("overflow-hidden"):a.classList.remove("overflow-hidden"),()=>a.classList.remove("overflow-hidden")},[j,r]),n.useEffect(()=>{let t;return R&&(t=setInterval(()=>{B(Math.floor((Date.now()-R.getTime())/1e3))},1e3)),()=>{t&&clearInterval(t)}},[R]),n.useEffect(()=>{if(P.length>0){const t=()=>{de(a=>a.map(s=>({...s,x:s.x+s.vx,y:s.y+s.vy,vy:s.vy-.15,life:s.life-1,size:s.size*.99})).filter(s=>s.life>0)),P.length>0&&(T.current=requestAnimationFrame(t))};T.current=requestAnimationFrame(t)}return()=>{T.current&&cancelAnimationFrame(T.current)}},[P.length]);const M=async()=>{try{const t=await w.get("/api/solo/taken");if(t.success){const a=(t.data||[]).reduce((s,i)=>(s[i.challenge_id]=i.status,s),{});ue(a)}}catch(t){console.error("Error fetching taken rows:",t),ue({})}},I=async()=>{try{ie(!0);const t={};q!=="all"&&(t.mode=q),C!=="all"&&(t.language=C),S!=="all"&&(t.difficulty=S),A.trim()&&(t.search=A.trim());const a=await w.get("/api/challenges/solo",t);if(a.success){const s=a.data.data||a.data||[];ne(s)}}catch(t){console.error("Error fetching challenges:",t),ne([])}finally{ie(!1)}},$=async()=>{var t,a,s;try{ce(!0);const i=await w.get("/api/me/stats");if(i.success&&i.data){const o=i.data,p=((t=o.totals)==null?void 0:t.xp)||0;let l=[];if(o.completed_challenge_ids&&Array.isArray(o.completed_challenge_ids))l=o.completed_challenge_ids;else if((a=o.solo_stats)!=null&&a.completed_challenge_ids)l=o.solo_stats.completed_challenge_ids;else if(o.attempts){const m=o.attempts.filter(u=>u.is_correct);l=[...new Set(m.map(u=>u.challenge_id))]}else{const m=["completed_challenges","solo_completed_challenges","successful_challenge_ids","completed_solo_challenges"];for(const u of m)if(o[u]&&Array.isArray(o[u])){l=o[u],console.log(`Found completed challenges in field: ${u}`);break}}U({solo_attempts:o.solo_attempts||0,successful_attempts:o.successful_attempts||l.length,total_xp:p,total_stars:((s=o.totals)==null?void 0:s.stars)||0,attempts_today:o.attempts_today||0,current_level:ee(p),xp_to_next_level:te(p),completed_challenge_ids:l,streak:o.streak||0})}}catch(i){console.error("Error fetching user stats:",i),U({solo_attempts:0,successful_attempts:0,total_xp:0,total_stars:0,attempts_today:0,current_level:1,xp_to_next_level:10,completed_challenge_ids:[],streak:0})}finally{ce(!1)}},ge=(t,a,s="success")=>{const i={success:["#10B981","#34D399","#6EE7B7","#FBBF24","#F59E0B"],levelup:["#8B5CF6","#A78BFA","#C4B5FD","#F59E0B","#FBBF24"],streak:["#EF4444","#F87171","#FCA5A5","#FBBF24","#F59E0B"]},o=[],p=s==="levelup"?25:15;for(let l=0;l<p;l++){const m=Math.PI*2*l/p,u=Math.random()*8+4;o.push({id:Date.now()+l,x:t+(Math.random()-.5)*50,y:a+(Math.random()-.5)*30,vx:Math.cos(m)*u+(Math.random()-.5)*2,vy:Math.sin(m)*u-Math.random()*3,life:80+Math.random()*40,maxLife:80,color:i[s][Math.floor(Math.random()*i[s].length)],size:Math.random()*6+3,type:s})}de(l=>[...l,...o])},Me=()=>{const t=document.documentElement;t.requestFullscreen?t.requestFullscreen():t.webkitRequestFullscreen?t.webkitRequestFullscreen():t.msRequestFullscreen&&t.msRequestFullscreen()},Ie=()=>{var t;document.fullscreenElement&&((t=document.exitFullscreen)==null||t.call(document))},$e=t=>{if(d.play("click"),Me(),c!=null&&c.completed_challenge_ids.includes(t.id)){d.play("failure"),f.fire({icon:"info",title:"Challenge Already Completed!",text:"You have already solved this challenge. Try a different one!",timer:2e3,showConfirmButton:!1,background:"#1f2937",color:"#fff"});return}Y(t),E(t.buggy_code||""),O(!0),H(new Date),B(0)},he=(t,a)=>{const s=t.length,i=a.length;if(s===0)return i===0?1:0;if(i===0)return 0;const o=Array(i+1).fill(null).map(()=>Array(s+1).fill(null));for(let l=0;l<=s;l++)o[0][l]=l;for(let l=0;l<=i;l++)o[l][0]=l;for(let l=1;l<=i;l++)for(let m=1;m<=s;m++)t[m-1]===a[l-1]?o[l][m]=o[l-1][m-1]:o[l][m]=Math.min(o[l-1][m]+1,o[l][m-1]+1,o[l-1][m-1]+1);const p=Math.max(s,i);return(p-o[i][s])/p},ze=(t,a)=>{var k,_;const s=t.trim(),i=(k=a.fixed_code)==null?void 0:k.trim();if(!s)return console.log("Code validation: FAIL - No code provided"),!1;if(!i)return console.log("Code validation: FAIL - No solution available in database"),!1;if(s===((_=a.buggy_code)==null?void 0:_.trim()))return console.log("Code validation: FAIL - No changes made from original buggy code"),!1;const o=ae=>ae.replace(/\r\n/g,`
`).replace(/\s+/g," ").replace(/\s*;\s*/g,";").replace(/\s*\{\s*/g,"{").replace(/\s*\}\s*/g,"}").replace(/\s*\(\s*/g,"(").replace(/\s*\)\s*/g,")").replace(/\s*==\s*/g,"==").replace(/\s*=\s*/g,"=").trim(),p=o(s),l=o(i);if(p===l)return console.log("Code validation: PASS - Exact match with database solution (100%)"),!0;const u=he(p,l),b=Math.round(u*100);console.log(`Code validation: FAIL - Only ${b}% similarity with database solution (requires 100%)`);const N=u>=1;return console.log(`Code validation: ${N?"PASS":"FAIL"} (${b}% similarity, requires 100%)`),N},Xe=async()=>{var t;if(!r||!h.trim()){d.play("failure"),f.fire("Error","Please write some code before submitting.","error");return}try{if(D(!0),d.play("typing"),!r.fixed_code){d.play("failure"),f.fire("Error","This challenge does not have a solution stored in the database.","error"),D(!1);return}const a=ze(h,r),s=he(h.trim().replace(/\s+/g," "),r.fixed_code.trim().replace(/\s+/g," "));W({isCorrect:a,similarity:s}),G(!0);const i={challenge_id:r.id,language:r.language,mode:r.mode,time_spent_sec:v,is_correct:a,code_submitted:h,judge_feedback:a?"Perfect! Your solution is an exact match with the expected answer from database (100% match).":`Incorrect. Your solution has ${Math.round(s*100)}% similarity with the expected answer. You need 100% match to pass. Try again or view the correct answer.`},o=await w.post("/api/solo/attempts",i);if(o.success){const p=((t=o.data)==null?void 0:t.xp_earned)||(a?r.reward_xp:0);if(a){await w.post("/api/solo/mark-taken",{challenge_id:r.id,language:r.language,difficulty:r.difficulty,mode:r.mode,status:"completed",time_spent_sec:v,code_submitted:h,earned_xp:p??0});const l=(c==null?void 0:c.total_xp)||0,m=l+p,u=ee(l),b=ee(m),N=b>u;c&&!c.completed_challenge_ids.includes(r.id)&&U(X=>X?{...X,completed_challenge_ids:[...X.completed_challenge_ids,r.id],successful_attempts:X.successful_attempts+1,total_xp:m,current_level:b,xp_to_next_level:te(m)}:null),d.play("success"),Q(!0),V(!0),Z(!0),pe(!0),setTimeout(()=>pe(!1),2e3);const k=window.innerWidth/2,_=window.innerHeight/2;ge(k,_,"success"),N&&setTimeout(()=>{d.play("levelup"),K(!0),ge(k,_-100,"levelup")},1e3),setTimeout(()=>{d.play("victory")},500);const{isConfirmed:ae}=await f.fire({title:"PERFECT SOLUTION!",html:`
  ...
  `,showConfirmButton:!0,confirmButtonText:"Continue Coding!",confirmButtonColor:"#10B981",background:"linear-gradient(135deg, #1e3a8a 0%, #312e81 100%)",color:"#fff",allowOutsideClick:!1,allowEscapeKey:!1});ae&&(Q(!1),V(!1),K(!1),Z(!1),O(!1),Y(null),E(""),H(null),B(0),G(!1),W(null),J(!1),await Promise.all([I(),$(),M()])),setTimeout(()=>{Q(!1),V(!1),K(!1),Z(!1)},7e3)}else d.play("failure"),me(!0),setTimeout(()=>me(!1),600),await f.fire({title:"Almost There!",html:`
                            <div class="text-center">
                        ...
                        `,timer:4500,showConfirmButton:!0,confirmButtonText:"Try Again",background:"linear-gradient(135deg, #1e3a8a 0%, #312e81 100%)",color:"#fff",confirmButtonColor:"#3B82F6"});await Promise.all([$(),I()]),await M()}else throw new Error(o.message||"Submission failed")}catch(a){console.error("Error submitting attempt:",a),d.play("failure");let s="Failed to submit your attempt. Please try again.";a instanceof Error&&(s=a.message),f.fire("Error",s,"error")}finally{D(!1)}},Ue=async t=>{try{if(r){const a={challenge_id:r.id,language:r.language,difficulty:r.difficulty,mode:r.mode,status:t,time_spent_sec:v,code_submitted:h||r.buggy_code||"",earned_xp:t==="completed"?r.reward_xp??0:0};await w.post("/api/solo/mark-taken",a),console.log(`Challenge marked as ${t} in database`)}}catch(a){console.error("Error marking challenge as taken:",a),f.fire({title:"Warning",text:"Progress may not have been saved properly.",icon:"warning",timer:1500,showConfirmButton:!1,background:"#1f2937",color:"#fff"})}finally{d.play("click"),O(!1),Y(null),E(""),H(null),B(0),G(!1),W(null),J(!1),Ie(),await I(),await $(),await M()}},qe=async()=>{!(r!=null&&r.fixed_code)||!(await f.fire({title:`
    ...
    `,showCancelButton:!0,confirmButtonText:"Show Answer",cancelButtonText:"Cancel",background:"#0f172a",color:"#f8fafc",confirmButtonColor:"#ef4444",cancelButtonColor:"#6b7280",width:600,customClass:{popup:"rounded-xl border border-gray-700/50"}})).isConfirmed||(d.play("click"),await f.fire({title:"Correct Answer",html:`
    ...
    `,didOpen:()=>{const a=document.getElementById("solo-surrender-solution");a&&(a.textContent=r.fixed_code||"")},confirmButtonText:"Got it",confirmButtonColor:"#10B981",background:"#1f2937",color:"#fff",width:700}),await Ue("abandoned"))},Ye=()=>{r!=null&&r.fixed_code&&(d.play("click"),J(!0),Ge("Correct Answer",r.fixed_code),f.fire({title:"Correct Answer",html:`
                    <div class="correct-answer-modal">
                        <p class="mb-4 text-gray-300">Here's the exact solution from the database (100% match required):</p>
                        <div class="bg-gray-900 rounded-lg p-4 text-left">
                ...
                `,didOpen:()=>{const t=document.getElementById("solo-solution");t&&(t.textContent=r.fixed_code)},confirmButtonText:"Got it!",background:"#1f2937",color:"#fff",confirmButtonColor:"#10B981",width:"600px"}))},Oe=t=>{switch(t){case"easy":return x.chipEasyStyle;case"medium":return x.chipMedStyle;case"hard":return x.chipHardStyle;default:return x.chipBlueStyle}},De=t=>t==="fixbugs"?lt:ot,be=t=>t==="fixbugs"?"text-yellow-400":"text-purple-400",Re=t=>{const a=Math.floor(t/60),s=t%60;return`${a}:${s.toString().padStart(2,"0")}`},He=new Set(["completed","abandoned"]),se=oe.filter(t=>{const a=c==null?void 0:c.completed_challenge_ids.includes(t.id),s=Te[t.id];return!(a||s&&He.has(s))}),z=({title:t,value:a,icon:s,color:i,animated:o=!1})=>e.jsx("div",{className:`
