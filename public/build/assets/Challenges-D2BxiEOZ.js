import{K as $e,r as i,j as e,L as Ee}from"./app-BVYNLR-_.js";import{a as _,A as De,T as C}from"./app-layout-BRr2wfTB.js";import{S as o}from"./sweetalert2.esm.all-K5NXPlLw.js";import{C as F}from"./users-CwK8ZoTu.js";import{c as z}from"./createLucideIcon-DaoKx46w.js";import{P as Me}from"./plus-DmJ2Ys_q.js";import{S as k,X as le}from"./x-qbPulonp.js";import{Z as j}from"./zap-CIw-zpZf.js";import{C as Te}from"./chart-column-BYNmSH3v.js";import{S as Fe}from"./search-HEelw0kx.js";import{R as se}from"./refresh-cw-k2ChDd6R.js";import{T as Be}from"./triangle-alert-Clo-sB2G.js";import{E as Le}from"./eye-CCs0zdqy.js";import{S as Ie,T as Ae}from"./trash-2-CJQYRQfZ.js";import"./utils-jAU0Cazi.js";/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const He=[["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}],["polyline",{points:"7 10 12 15 17 10",key:"2ggqvy"}],["line",{x1:"12",x2:"12",y1:"15",y2:"3",key:"1vk2je"}]],Je=z("Download",He);/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Pe=[["polygon",{points:"22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3",key:"1yg77f"}]],Oe=z("Filter",Pe);/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ue=[["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}],["polyline",{points:"17 8 12 3 7 8",key:"t8dd8p"}],["line",{x1:"12",x2:"12",y1:"3",y2:"15",key:"widbto"}]],U=z("Upload",Ue),Re={width:640,background:"linear-gradient(180deg, #0E1B2E 0%, #0A1527 100%)",color:"#E6F0FF",showConfirmButton:!0,confirmButtonColor:"#22C55E",customClass:{popup:"swal-neo",title:"swal-title-neo",htmlContainer:"swal-html-neo",confirmButton:"swal-confirm-neo"}},R=x=>({...Re,...x}),qe=[{title:"Home",href:"/dashboard"},{title:"Admin",href:"/dashboard"},{title:"Challenge Management",href:"/admin/challenges"}],ze=(x,y="slate")=>{const u={blue:"bg-blue-500/10 text-blue-300 border-blue-500/30",green:"bg-green-500/10 text-green-300 border-green-500/30",yellow:"bg-yellow-500/10 text-yellow-300 border-yellow-500/30",red:"bg-red-500/10 text-red-300 border-red-500/30",purple:"bg-purple-500/10 text-purple-300 border-purple-500/30",slate:"bg-white/5 text-slate-300 border-white/10"};return e.jsx("span",{className:`px-2 py-0.5 text-[11px] rounded-md border ${u[y]} inline-flex items-center gap-1`,children:x})};function q({title:x,right:y,children:u,className:f=""}){return e.jsxs("div",{className:f,children:[e.jsx("div",{className:"sticky top-6 z-10 mb-3",children:e.jsxs("div",{className:"flex items-center justify-between bg-slate-900/70 border border-white/10 rounded-xl px-3 py-2 backdrop-blur supports-[backdrop-filter]:bg-slate-900/50",children:[e.jsx("div",{className:"flex items-center gap-2",children:x}),e.jsx("div",{className:"flex items-center gap-2",children:y})]})}),u]})}function c({icon:x,label:y,value:u,tone:f="slate",hint:p}){const B={blue:"ring-blue-500/20 hover:ring-blue-500/40",green:"ring-green-500/20 hover:ring-green-500/40",yellow:"ring-yellow-500/20 hover:ring-yellow-500/40",red:"ring-red-500/20 hover:ring-red-500/40",purple:"ring-purple-500/20 hover:ring-purple-500/40",slate:"ring-white/10 hover:ring-white/20"};return e.jsx("div",{className:`rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm p-4 transition ring-1 ${B[f]}`,children:e.jsxs("div",{className:"flex items-start justify-between gap-3",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("div",{className:"p-2 rounded-lg border border-white/10 bg-white/5",children:e.jsx(x,{className:"h-5 w-5 text-white/90"})}),e.jsxs("div",{children:[e.jsx("p",{className:"text-[11px] uppercase tracking-wide text-white/60",children:y}),e.jsx("p",{className:"text-2xl font-bold text-white leading-none",children:u})]})]}),p?ze(p,f):null]})})}const Ve={solo:{python:0,java:0,cpp:0,total:0},v1:{python:0,java:0,cpp:0,total:0},soloDiff:{easy:0,medium:0,hard:0},v1Diff:{easy:0,medium:0,hard:0}};function nt(){const{props:x}=$e(),y=x==null?void 0:x.activeType,[u,f]=i.useState([]),[p,B]=i.useState(null),[L,V]=i.useState(!0),[n,X]=i.useState("solo"),[v,W]=i.useState(""),[S,ae]=i.useState("all"),[$,re]=i.useState("all"),[g,oe]=i.useState(Ve),[ie,E]=i.useState(!1),[Y,ne]=i.useState("fixbugs"),[I,de]=i.useState("python"),[A,ce]=i.useState("easy"),[w,D]=i.useState([]),[H,Z]=i.useState(!1),K=t=>t==="cpp"?"C++":(t??"").toUpperCase();i.useMemo(()=>L?"—":u.length,[L,u.length]);const[G,pe]=i.useState(!0),[Q,ge]=i.useState(!0),[ee,xe]=i.useState(!0);i.useEffect(()=>{M(),J()},[n,v,S,$]);const M=async()=>{try{V(!0);const t=n==="solo"?"/api/challenges/solo":"/api/challenges/1v1",l={};v.trim()&&(l.search=v.trim()),S!=="all"&&(l.language=S),$!=="all"&&(l.difficulty=$);const r=await _.get(t,l);if(r.success){const s=r.data.data||r.data||[];f(s.map(a=>({...a,type:n})))}else f([])}catch(t){console.error("Error fetching challenges:",t),f([])}finally{V(!1)}},J=async()=>{try{const t=await _.get("/dashboard/stats");if(t.success){const l=t.data;B({total_solo_challenges:l.total_solo_challenges||0,total_1v1_challenges:l.total_1v1_challenges||0,fixbugs_challenges:l.fixbugs_challenges??0,random_challenges:l.random_challenges??0,solo_python_challenges:l.solo_python_challenges??0,solo_java_challenges:l.solo_java_challenges??0,solo_cpp_challenges:l.solo_cpp_challenges??0,duel_python_challenges:l.duel_python_challenges??0,duel_java_challenges:l.duel_java_challenges??0,duel_cpp_challenges:l.duel_cpp_challenges??0,solo_easy:l.solo_easy??0,solo_medium:l.solo_medium??0,solo_hard:l.solo_hard??0,duel_easy:l.duel_easy??0,duel_medium:l.duel_medium??0,duel_hard:l.duel_hard??0}),oe({solo:{python:l.solo_python_challenges??0,java:l.solo_java_challenges??0,cpp:l.solo_cpp_challenges??0,total:l.total_solo_challenges??0},v1:{python:l.duel_python_challenges??0,java:l.duel_java_challenges??0,cpp:l.duel_cpp_challenges??0,total:l.total_1v1_challenges??0},soloDiff:{easy:l.solo_easy??0,medium:l.solo_medium??0,hard:l.solo_hard??0},v1Diff:{easy:l.duel_easy??0,medium:l.duel_medium??0,hard:l.duel_hard??0}})}}catch(t){console.error("Error fetching stats:",t)}},ue=async t=>{if((await o.fire({title:"Delete Challenge?",text:"This action cannot be undone.",icon:"warning",showCancelButton:!0,confirmButtonColor:"#d33",cancelButtonColor:"#3085d6",confirmButtonText:"Yes, delete it!"})).isConfirmed)try{const r=n==="solo"?`/api/challenges/solo/${t}`:`/api/challenges/1v1/${t}`;(await _.delete(r)).success&&(f(u.filter(a=>a.id!==t)),J(),o.fire("Deleted!","Challenge has been deleted.","success"))}catch(r){console.error("Error deleting challenge:",r)}},he=t=>{if(!t)return;if(!t.name.endsWith(".json")){o.fire("Invalid File Type","Please select a JSON file (.json)","error");return}if(t.size>10*1024*1024){o.fire("File Too Large","File size must be less than 10MB","error");return}const l=new FileReader;l.onload=r=>{var s;try{const a=JSON.parse((s=r.target)==null?void 0:s.result);if(Array.isArray(a)){if(a.length===0){o.fire("Empty File","The JSON file contains no challenges.","warning");return}if(a.length>1e3){o.fire("Too Many Items","Maximum 1000 challenges can be imported at once.","error");return}D(a),o.fire({icon:"success",title:"File Loaded",text:`Successfully loaded ${a.length} challenges from ${t.name}`,timer:2e3,showConfirmButton:!1})}else o.fire("Invalid Format","File must contain an array of challenges.","error")}catch(a){console.error("JSON parse error:",a),o.fire("Invalid JSON","Unable to parse JSON file. Please check the file format.","error")}},l.onerror=()=>o.fire("File Read Error","Unable to read the file.","error"),l.readAsText(t)},me=async t=>{if(t.preventDefault(),w.length===0){o.fire("No Data","Please upload a JSON file or paste valid challenge array.","error");return}try{Z(!0);const l=n==="solo"?"/api/challenges/solo/import":"/api/challenges/1v1/import",r=n==="solo"?{mode:Y,language:I,difficulty:A,items:w,source_file:"manual_import"}:{language:I,difficulty:A,items:w,source_file:"manual_import"},s=await _.post(l,r);s.success?(E(!1),D([]),M(),J(),o.fire({icon:"success",title:"Import Successful!",text:`Successfully imported ${s.count||w.length} challenges.`,timer:3e3,showConfirmButton:!1})):o.fire({icon:"error",title:"Import Failed",text:s.message||"Unknown error occurred during import.",footer:s.errors?`Details: ${JSON.stringify(s.errors)}`:""})}catch(l){console.error("Error importing challenges:",l),o.fire({icon:"error",title:"Network Error",text:"An error occurred while importing challenges. Please check your connection and try again."})}finally{Z(!1)}},be=()=>Ce(n),fe=t=>_e(t),ye=t=>Ne(t,n),ve=t=>{const l=n==="solo"?`/admin/challenges/solo/${t}/export`:`/admin/challenges/1v1/${t}/export`;window.open(l,"_blank")},we=t=>t==="easy"?"bg-green-500/10 text-green-300 border-green-500/30":t==="medium"?"bg-yellow-500/10 text-yellow-300 border-yellow-500/30":t==="hard"?"bg-red-500/10 text-red-300 border-red-500/30":"bg-white/5 text-slate-300 border-white/10",je=t=>t==="fixbugs"?Be:t==="random"?j:F,d=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),T=(t,l)=>`
  ...
  <div class="rounded-xl overflow-hidden border border-white/10 bg-slate-900/80">
    ...
    <div class="space-y-4">
      <div class="flex flex-wrap gap-2">${[t.language?T("Language",K(String(t.language))):"",t.difficulty?T("Difficulty",String(t.difficulty).toUpperCase()):"",t.mode?T("Mode",String(t.mode)):"",t.reward_xp!=null?T("Reward",String(t.reward_xp)):""].filter(Boolean).join(" ")}</div>
  ...
  `;o.fire(R({width:960,html:O({icon:"👀",title:t.title||"View Challenge",subtitle:`Created ${new Date(t.created_at??Date.now()).toLocaleString()}`,bodyHTML:r}),confirmButtonText:"Close",customClass:{popup:"rounded-2xl !p-0 backdrop-blur-sm",confirmButton:"swal2-confirm !bg-cyan-600 hover:!bg-cyan-500 !rounded-lg !px-4 !py-2"},didOpen:()=>{document.querySelectorAll(".neo-copy").forEach(s=>{s.addEventListener("click",()=>{var h;const a=s.getAttribute("data-target"),m=((h=document.getElementById(a))==null?void 0:h.innerText)??"";navigator.clipboard.writeText(m);const b=s.textContent;s.textContent="Copied",setTimeout(()=>s.textContent=b,900)})})}}))},Ne=(t,l)=>{const r=l==="solo",s=`
    <div class="grid grid-cols-1 md:grid-cols-12 gap-3">
      <div class="md:col-span-7 space-y-3">
  ...
  `;o.fire(R({width:960,html:O({icon:"✏️",title:"Edit Challenge",subtitle:t.title?`Editing “${t.title}”`:"Update fields below",bodyHTML:s}),showCancelButton:!0,confirmButtonText:"Save",customClass:{popup:"rounded-2xl !p-0 backdrop-blur-sm",confirmButton:"swal2-confirm !bg-emerald-600 hover:!bg-emerald-500 !rounded-lg !px-4 !py-2",cancelButton:"swal2-cancel !bg-white/10 hover:!bg-white/20 !text-white !rounded-lg !px-4 !py-2",actions:"!px-5 !pb-4"},focusConfirm:!1,preConfirm:()=>{var b;const a=h=>{var N,te;return((te=(N=document.getElementById(h))==null?void 0:N.value)==null?void 0:te.trim())??""},m={title:a("f_title"),description:a("f_desc"),language:a("f_lang"),difficulty:a("f_diff"),buggy_code:a("f_bug"),fixed_code:a("f_fix")};if(r){m.mode=a("f_mode")||"fixbugs",m.hint=a("f_hint");const h=Number(((b=document.getElementById("f_reward"))==null?void 0:b.value)||"0");m.reward_xp=Number.isFinite(h)&&h>=0?Math.floor(h):0}return m.title?m:(o.showValidationMessage("Title is required"),!1)}})).then(a=>{a.isConfirmed&&ke(t.id,a.value,y||l)})},Ce=t=>{const l=t==="solo",r=`
    <div class="grid grid-cols-1 md:grid-cols-12 gap-3">
      <div class="md:col-span-7 space-y-3">
        <div class="rounded-lg border border-white/10 bg-white/5 p-3">
