import{K as We,r as n,j as e,L as Qe}from"./app-DlzFmktf.js";import{b as m,a as w,A as Je,T as be,C as Ke,S as f}from"./app-layout-DT6t5mmv.js";import{A as Ve}from"./AnimatedBackground-4NL-PFRt.js";import{C as re}from"./crown-83TNjvlV.js";import{S as ye}from"./sparkles-CrIb7ivP.js";import{T as ve}from"./trophy-DXEYjGmd.js";import{C as Ze}from"./circle-check-big-DyFfu6ej.js";import{S as et}from"./search-DDXWVlNH.js";import{R as we}from"./refresh-cw-DImLU39b.js";import{L as je}from"./lightbulb-yPhJeLbE.js";import{P as tt}from"./play-ClhiHCju.js";import{X as st,B as at}from"./x-xYP0BBVc.js";import{S as rt}from"./send-DV1ETi87.js";import{T as lt}from"./triangle-alert-CxNwqo2N.js";import{Z as ot}from"./zap-CsW0ZKiw.js";import"./utils-jAU0Cazi.js";import"./createLucideIcon-CBA5ZHu5.js";import"./users-CP76E7xk.js";const nt=[{title:"Home",href:"/dashboard"},{title:"Practice",href:"#"},{title:"Training Challenge",href:"/play/solo"}],x={panelClass:"rounded-xl border",panelStyle:{background:"var(--panel-bg, rgba(17,24,39,0.50))",borderColor:"var(--panel-border, rgba(75,85,99,0.50))",backdropFilter:"blur(6px)"},chipClass:"px-2 py-1 text-xs font-semibold rounded-full border",chipBlueStyle:{background:"var(--chip-blue-bg, rgba(30,58,138,0.30))",borderColor:"var(--chip-blue-border, rgba(59,130,246,0.50))",color:"var(--chip-blue-text, #93c5fd)"},chipEasyStyle:{background:"var(--chip-easy-bg, rgba(6,78,59,0.30))",borderColor:"var(--chip-easy-border, rgba(16,185,129,0.50))",color:"var(--chip-easy-text, #86efac)"},chipMedStyle:{background:"var(--chip-med-bg, rgba(113,63,18,0.30))",borderColor:"var(--chip-med-border, rgba(234,179,8,0.50))",color:"var(--chip-med-text, #fde68a)"},chipHardStyle:{background:"var(--chip-hard-bg, rgba(127,29,29,0.30))",borderColor:"var(--chip-hard-border, rgba(248,113,113,0.50))",color:"var(--chip-hard-text, #fca5a5)"},btnPrimaryClass:"rounded-lg shadow-lg hover:scale-110 transition-all duration-300",btnPrimaryStyle:{background:"var(--btn-primary, linear-gradient(90deg,#06b6d4,#2563eb))",color:"var(--btn-primary-text, #fff)"}},it={python:"Python",java:"Java",cpp:"C++"},Ne=y=>it[y]??y.toUpperCase();function Bt(){const{auth:y}=We().props;y==null||y.user;const[le,O]=n.useState([]),[c,U]=n.useState(null),[ke,oe]=n.useState(!0),[ct,ne]=n.useState(!0),[A,dt]=n.useState("all"),[j,_e]=n.useState("all"),[N,Ce]=n.useState("all"),[k,Se]=n.useState(""),[r,Y]=n.useState(null),[_,q]=n.useState(!1),[b,B]=n.useState(""),[L,D]=n.useState(!1),[v,F]=n.useState(0),[R,H]=n.useState(null),[T,G]=n.useState(!1),[g,W]=n.useState(null),[mt,Q]=n.useState(!1),[P,ie]=n.useState([]),[Ee,J]=n.useState(!1),[Ae,K]=n.useState(!1),[Be,ce]=n.useState(!1),[Le,V]=n.useState(!1),[Fe,Z]=n.useState(!1),[Te,de]=n.useState(!1),M=n.useRef(),[Pe,me]=n.useState({});n.useEffect(()=>{_?document.body.classList.add("modal-open"):document.body.classList.remove("modal-open")},[_]),n.useEffect(()=>{m.registerSfx("success","/sounds/correct.mp3"),m.registerSfx("failure","/sounds/failure.mp3"),m.registerSfx("levelup","/sounds/levelup.mp3"),m.registerSfx("click","/sounds/click.mp3"),m.registerSfx("hover","/sounds/hover.mp3"),m.registerSfx("victory","/sounds/victory.mp3"),m.registerSfx("streak","/sounds/streak.mp3"),m.registerSfx("typing","/sounds/typing.mp3")},[]);const ee=t=>Math.floor(t/10)+1,te=t=>10-t%10,pe=t=>t%10/10*100,ue=t=>t%10;n.useEffect(()=>{$(),z(),I()},[A,j,N,k]),n.useEffect(()=>{const t=!!(_&&r);try{window.__modalOpen=t,window.dispatchEvent(new CustomEvent("app:modal",{detail:{open:t}}))}catch{}const a=document.documentElement;return t?a.classList.add("overflow-hidden"):a.classList.remove("overflow-hidden"),()=>a.classList.remove("overflow-hidden")},[_,r]),n.useEffect(()=>{let t;return R&&(t=setInterval(()=>{F(Math.floor((Date.now()-R.getTime())/1e3))},1e3)),()=>{t&&clearInterval(t)}},[R]),n.useEffect(()=>{if(P.length>0){const t=()=>{ie(a=>a.map(s=>({...s,x:s.x+s.vx,y:s.y+s.vy,vy:s.vy-.15,life:s.life-1,size:s.size*.99})).filter(s=>s.life>0)),P.length>0&&(M.current=requestAnimationFrame(t))};M.current=requestAnimationFrame(t)}return()=>{M.current&&cancelAnimationFrame(M.current)}},[P.length]);const I=async()=>{try{const t=await w.get("/api/solo/taken");if(t.success){const a=(t.data||[]).reduce((s,i)=>(s[i.challenge_id]=i.status,s),{});me(a)}}catch(t){console.error("Error fetching taken rows:",t),me({})}},$=async()=>{var t;try{oe(!0);const a={mode:A||"all",language:j||"all",difficulty:N||"all",search:(k||"").trim()},s=await w.get("/api/challenges/solo",a);if(s!=null&&s.success){const o=(((t=s.data)==null?void 0:t.data)||s.data||[]).filter(p=>{const l=j==="all"||p.language===j,d=N==="all"||p.difficulty===N,u=A==="all"||p.mode===A,h=!k.trim()||(p.title||"").toLowerCase().includes(k.trim().toLowerCase());return l&&d&&u&&h});O(o)}else O([])}catch(a){console.error("Error fetching challenges:",a),O([])}finally{oe(!1)}},z=async()=>{var t,a,s;try{ne(!0);const i=await w.get("/api/me/stats");if(i.success&&i.data){const o=i.data,p=((t=o.totals)==null?void 0:t.xp)||0;let l=[];if(o.completed_challenge_ids&&Array.isArray(o.completed_challenge_ids))l=o.completed_challenge_ids;else if((a=o.solo_stats)!=null&&a.completed_challenge_ids)l=o.solo_stats.completed_challenge_ids;else if(o.attempts){const d=o.attempts.filter(u=>u.is_correct);l=[...new Set(d.map(u=>u.challenge_id))]}else{const d=["completed_challenges","solo_completed_challenges","successful_challenge_ids","completed_solo_challenges"];for(const u of d)if(o[u]&&Array.isArray(o[u])){l=o[u],console.log(`Found completed challenges in field: ${u}`);break}}U({solo_attempts:o.solo_attempts||0,successful_attempts:o.successful_attempts||l.length,total_xp:p,total_stars:((s=o.totals)==null?void 0:s.stars)||0,attempts_today:o.attempts_today||0,current_level:ee(p),xp_to_next_level:te(p),completed_challenge_ids:l,streak:o.streak||0})}}catch(i){console.error("Error fetching user stats:",i),U({solo_attempts:0,successful_attempts:0,total_xp:0,total_stars:0,attempts_today:0,current_level:1,xp_to_next_level:10,completed_challenge_ids:[],streak:0})}finally{ne(!1)}},xe=(t,a,s="success")=>{const i={success:["#10B981","#34D399","#6EE7B7","#FBBF24","#F59E0B"],levelup:["#8B5CF6","#A78BFA","#C4B5FD","#F59E0B","#FBBF24"],streak:["#EF4444","#F87171","#FCA5A5","#FBBF24","#F59E0B"]},o=[],p=s==="levelup"?25:15;for(let l=0;l<p;l++){const d=Math.PI*2*l/p,u=Math.random()*8+4;o.push({id:Date.now()+l,x:t+(Math.random()-.5)*50,y:a+(Math.random()-.5)*30,vx:Math.cos(d)*u+(Math.random()-.5)*2,vy:Math.sin(d)*u-Math.random()*3,life:80+Math.random()*40,maxLife:80,color:i[s][Math.floor(Math.random()*i[s].length)],size:Math.random()*6+3,type:s})}ie(l=>[...l,...o])},Me=()=>{const t=document.documentElement;t.requestFullscreen?t.requestFullscreen():t.webkitRequestFullscreen?t.webkitRequestFullscreen():t.msRequestFullscreen&&t.msRequestFullscreen()},Ie=()=>{var t;document.fullscreenElement&&((t=document.exitFullscreen)==null||t.call(document))},$e=t=>{if(m.play("click"),Me(),c!=null&&c.completed_challenge_ids.includes(t.id)){m.play("failure"),f.fire({icon:"info",title:"Challenge Already Completed!",text:"You have already solved this challenge. Try a different one!",timer:2e3,showConfirmButton:!1,background:"#1f2937",color:"#fff"});return}Y(t),B(t.buggy_code||""),q(!0),H(new Date),F(0)},fe=(t,a)=>{const s=t.length,i=a.length;if(s===0)return i===0?1:0;if(i===0)return 0;const o=Array(i+1).fill(null).map(()=>Array(s+1).fill(null));for(let l=0;l<=s;l++)o[0][l]=l;for(let l=0;l<=i;l++)o[l][0]=l;for(let l=1;l<=i;l++)for(let d=1;d<=s;d++)t[d-1]===a[l-1]?o[l][d]=o[l-1][d-1]:o[l][d]=Math.min(o[l-1][d]+1,o[l][d-1]+1,o[l-1][d-1]+1);const p=Math.max(s,i);return(p-o[i][s])/p},ze=(t,a)=>{var S,E;const s=t.trim(),i=(S=a.fixed_code)==null?void 0:S.trim();if(!s)return console.log("Code validation: FAIL - No code provided"),!1;if(!i)return console.log("Code validation: FAIL - No solution available in database"),!1;if(s===((E=a.buggy_code)==null?void 0:E.trim()))return console.log("Code validation: FAIL - No changes made from original buggy code"),!1;const o=ae=>ae.replace(/\r\n/g,`
`).replace(/\s+/g," ").replace(/\s*;\s*/g,";").replace(/\s*\{\s*/g,"{").replace(/\s*\}\s*/g,"}").replace(/\s*\(\s*/g,"(").replace(/\s*\)\s*/g,")").replace(/\s*==\s*/g,"==").replace(/\s*=\s*/g,"=").trim(),p=o(s),l=o(i);if(p===l)return console.log("Code validation: PASS - Exact match with database solution (100%)"),!0;const u=fe(p,l),h=Math.round(u*100);console.log(`Code validation: FAIL - Only ${h}% similarity with database solution (requires 100%)`);const C=u>=1;return console.log(`Code validation: ${C?"PASS":"FAIL"} (${h}% similarity, requires 100%)`),C},Xe=async()=>{var t;if(!r||!b.trim()){m.play("failure"),f.fire("Error","Please write some code before submitting.","error");return}try{if(D(!0),m.play("typing"),!r.fixed_code){m.play("failure"),f.fire("Error","This challenge does not have a solution stored in the database.","error"),D(!1);return}const a=ze(b,r),s=fe(b.trim().replace(/\s+/g," "),r.fixed_code.trim().replace(/\s+/g," "));W({isCorrect:a,similarity:s}),G(!0);const i={challenge_id:r.id,language:r.language,mode:r.mode,time_spent_sec:v,is_correct:a,code_submitted:b,judge_feedback:a?"Perfect! Your solution is an exact match with the expected answer from database (100% match).":`Incorrect. Your solution has ${Math.round(s*100)}% similarity with the expected answer. You need 100% match to pass. Try again or view the correct answer.`},o=await w.post("/api/solo/attempts",i);if(o.success){const p=((t=o.data)==null?void 0:t.xp_earned)||(a?r.reward_xp:0);if(a){await w.post("/api/solo/mark-taken",{challenge_id:r.id,language:r.language,difficulty:r.difficulty,mode:r.mode,status:"completed",time_spent_sec:v,code_submitted:b,earned_xp:p??0});const l=(c==null?void 0:c.total_xp)||0,d=l+p,u=ee(l),h=ee(d),C=h>u;c&&!c.completed_challenge_ids.includes(r.id)&&U(X=>X?{...X,completed_challenge_ids:[...X.completed_challenge_ids,r.id],successful_attempts:X.successful_attempts+1,total_xp:d,current_level:h,xp_to_next_level:te(d)}:null),m.play("success"),K(!0),V(!0),Z(!0),de(!0),setTimeout(()=>de(!1),2e3);const S=window.innerWidth/2,E=window.innerHeight/2;xe(S,E,"success"),C&&setTimeout(()=>{m.play("levelup"),J(!0),xe(S,E-100,"levelup")},1e3),setTimeout(()=>{m.play("victory")},500);const{isConfirmed:ae}=await f.fire({title:"PERFECT SOLUTION!",html:`
    <div class="text-center">
      ...
      ${C?`
        <div class="mt-4 text-center">
          ...
          <p class="text-sm text-gray-200">You’ve reached Level ${h}! Next: ${te(d)} XP needed.</p>
        </div>
      `:""}
    </div>
  `,showConfirmButton:!0,confirmButtonText:"Continue Coding!",confirmButtonColor:"#10B981",background:"linear-gradient(135deg, #1e3a8a 0%, #312e81 100%)",color:"#fff",allowOutsideClick:!1,allowEscapeKey:!1});ae&&(K(!1),V(!1),J(!1),Z(!1),q(!1),Y(null),B(""),H(null),F(0),G(!1),W(null),Q(!1),await Promise.all([$(),z(),I()])),setTimeout(()=>{K(!1),V(!1),J(!1),Z(!1)},7e3)}else m.play("failure"),ce(!0),setTimeout(()=>ce(!1),600),await f.fire({title:"Almost There!",html:`
                                              <div class="text-center">
    ...
    `,width:600,background:"#1f2937",color:"#f8fafc",confirmButtonText:"Close",confirmButtonColor:"#10B981",customClass:{popup:"rounded-xl border border-gray-700/50 shadow-xl backdrop-blur-sm",confirmButton:"px-6 py-2 rounded-lg font-semibold"},didOpen:()=>{const a=document.getElementById("solo-surrender-solution");a&&(a.textContent=r.fixed_code||"")}}),await Oe("abandoned"))},Ye=()=>{r!=null&&r.fixed_code&&(m.play("click"),Q(!0),Ge("Correct Answer",r.fixed_code),f.fire({title:"Correct Answer",html:`
                ...
                `,didOpen:()=>{const t=document.getElementById("solo-solution");t&&(t.textContent=r.fixed_code)},confirmButtonText:"Got it!",background:"#1f2937",color:"#fff",confirmButtonColor:"#10B981",width:"600px"}))},qe=t=>{switch(t){case"easy":return x.chipEasyStyle;case"medium":return x.chipMedStyle;case"hard":return x.chipHardStyle;default:return x.chipBlueStyle}},De=t=>t==="fixbugs"?lt:ot,ge=t=>t==="fixbugs"?"text-yellow-400":"text-purple-400",Re=t=>{const a=Math.floor(t/60),s=t%60;return`${a}:${s.toString().padStart(2,"0")}`},He=new Set(["completed","abandoned"]),he=le.filter(t=>{const a=c==null?void 0:c.completed_challenge_ids.includes(t.id),s=Pe[t.id];return!(a||s&&He.has(s))}),se=({title:t,value:a,icon:s,color:i,animated:o=!1})=>e.jsx("div",{className:`
                bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-4 
                ${o?"animate-pulse glow-effect":""} 
                hover:scale-105 hover:shadow-xl transition-all duration-300 
                ${Fe?"glow-success":""}
                cursor-pointer
            `,onMouseEnter:()=>m.play("hover"),children:e.jsxs("div",{className:"flex items-center space-x-3",children:[e.jsx("div",{className:`p-2 rounded-lg ${i} transition-all duration-300`,children:e.jsx(s,{className:"h-5 w-5 text-white"})}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs text-gray-400",children:t}),e.jsx("p",{className:"text-lg font-bold text-white",children:a})]})]})}),Ge=(t,a)=>{f.fire({title:t,html:`
      <div>
