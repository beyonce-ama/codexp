...
`).replace(/\s+/g," ").replace(/\s*;\s*/g,";").replace(/\s*\{\s*/g,"{").replace(/\s*\}\s*/g,"}").replace(/\s*\(\s*/g,"(").replace(/\s*\)\s*/g,")").replace(/\s*==\s*/g,"==").replace(/\s*=\s*/g,"=").trim(),p=r(s),o=r(n);if(p===o)return console.log("Code validation: PASS - Exact match with database solution (100%)"),!0;const x=ke(p,o),y=Math.round(x*100);console.log(`Code validation: FAIL - Only ${y}% similarity with database solution (requires 100%)`);const _=x>=1;return console.log(`Code validation: ${_?"PASS":"FAIL"} (${y}% similarity, requires 100%)`),_},Qe=async()=>{var t;if(!l||!h.trim()){d.play("failure"),u.fire("Error","Please write some code before submitting.","error");return}try{if(H(!0),d.play("typing"),!l.fixed_code){d.play("failure"),u.fire("Error","This challenge does not have a solution stored in the database.","error"),H(!1);return}const a=We(h,l),s=ke(h.trim().replace(/\s+/g," "),l.fixed_code.trim().replace(/\s+/g," "));J({isCorrect:a,similarity:s}),Q(!0);const n={challenge_id:l.id,language:l.language,mode:l.mode,time_spent_sec:k,is_correct:a,code_submitted:h,judge_feedback:a?"Perfect! Your solution is an exact match with the expected answer from database (100% match).":`Incorrect. Your solution has ${Math.round(s*100)}% similarity with the expected answer. You need 100% match to pass. Try again or view the correct answer.`},r=Ie?await b.post("/api/solo/retake",n):await b.post("/api/solo/attempts",n);if(r.success){const p=((t=r.data)==null?void 0:t.xp_earned)||(a?l.reward_xp:0);if(a){await b.post("/api/solo/mark-taken",{challenge_id:l.id,language:l.language,difficulty:l.difficulty,mode:l.mode,status:"completed",time_spent_sec:k,code_submitted:h,earned_xp:p??0});const o=(c==null?void 0:c.total_xp)||0,m=o+p,x=ae(o),y=ae(m),_=y>x;c&&!c.completed_challenge_ids.includes(l.id)&&R(X=>X?{...X,completed_challenge_ids:[...X.completed_challenge_ids,l.id],successful_attempts:X.successful_attempts+1,total_xp:m,current_level:y,xp_to_next_level:le(m)}:null),d.play("success"),ee(!0),te(!0),se(!0),be(!0),setTimeout(()=>be(!1),2e3);const S=window.innerWidth/2,E=window.innerHeight/2;je(S,E,"success"),_&&setTimeout(()=>{d.play("levelup"),Z(!0),je(S,E-100,"levelup")},1e3),setTimeout(()=>{d.play("victory")},500);const{isConfirmed:oe}=await u.fire({title:"PERFECT SOLUTION!",html:`
  ...
  `,showConfirmButton:!0,confirmButtonText:"Continue Coding!",confirmButtonColor:"#10B981",background:"linear-gradient(135deg, #1e3a8a 0%, #312e81 100%)",color:"#fff",allowOutsideClick:!1,allowEscapeKey:!1});oe&&(ee(!1),te(!1),Z(!1),se(!1),O(!1),D(null),L(""),W(null),F(0),Q(!1),J(null),K(!1),await Promise.all([$(),z(),I()])),setTimeout(()=>{ee(!1),te(!1),Z(!1),se(!1)},7e3)}else d.play("failure"),he(!0),setTimeout(()=>he(!1),600),await u.fire({title:"Almost There!",html:`
                                              <div class="text-center">
    ...
    `,width:600,background:"#1f2937",color:"#f8fafc",confirmButtonText:"Close",confirmButtonColor:"#10B981",customClass:{popup:"rounded-xl border border-gray-700/50 shadow-xl backdrop-blur-sm",confirmButton:"px-6 py-2 rounded-lg font-semibold"},didOpen:()=>{const a=document.getElementById("solo-surrender-solution");a&&(a.textContent=l.fixed_code||"")}}),await Je("abandoned"))},Ve=()=>{l!=null&&l.fixed_code&&(d.play("click"),K(!0),at("Correct Answer",l.fixed_code),u.fire({title:"Correct Answer",html:`
                ...
                `,didOpen:()=>{const t=document.getElementById("solo-solution");t&&(t.textContent=l.fixed_code)},confirmButtonText:"Got it!",background:"#1f2937",color:"#fff",confirmButtonColor:"#10B981",width:"600px"}))},Ze=t=>{switch(t){case"easy":return f.chipEasyStyle;case"medium":return f.chipMedStyle;case"hard":return f.chipHardStyle;default:return f.chipBlueStyle}},et=t=>t==="fixbugs"?ut:ft,Ce=t=>t==="fixbugs"?"text-yellow-400":"text-purple-400",tt=t=>{const a=Math.floor(t/60),s=t%60;return`${a}:${s.toString().padStart(2,"0")}`},st=new Set(["completed","abandoned"]),_e=Y.filter(t=>{const a=c==null?void 0:c.completed_challenge_ids.includes(t.id),s=De[t.id];return!(a||s&&st.has(s))}),re=({title:t,value:a,icon:s,color:n,animated:r=!1})=>e.jsx("div",{className:`
