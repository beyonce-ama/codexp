import{K as We,r as i,j as e,L as Je}from"./app-S8Gj7UnV.js";import{b as m,a as w,A as Ke,T as re,C as Qe}from"./app-layout-D6P1xQZ2.js";import{S as f}from"./sweetalert2.esm.all-acGi8jXx.js";import{A as Ve}from"./AnimatedBackground-t4u2Crfz.js";import{C as le}from"./crown-BlX5KWoQ.js";import{S as we}from"./sparkles-DdCz3C_1.js";import{T as je}from"./trophy-oCU_2xKP.js";import{C as Ze}from"./circle-check-big-DClANhSw.js";import{S as et}from"./search-DRuJyQxY.js";import{R as Ne}from"./refresh-cw-CCkzvxAg.js";import{L as ke}from"./lightbulb-Dc6WqI1O.js";import{P as tt}from"./play-CDaQxfOx.js";import{B as at}from"./x-aBnHjvD1.js";import{S as st}from"./send-BFo5SGio.js";import{T as rt}from"./triangle-alert-Cj7WB7ct.js";import{Z as lt}from"./zap-IkkGIYe8.js";import"./utils-jAU0Cazi.js";import"./createLucideIcon-nHfNlitK.js";import"./users-CrWWAf5S.js";const ot=[{title:"Home",href:"/dashboard"},{title:"Practice",href:"#"},{title:"Solo Challenge",href:"/play/solo"}],x={panelClass:"rounded-xl border",panelStyle:{background:"var(--panel-bg, rgba(17,24,39,0.50))",borderColor:"var(--panel-border, rgba(75,85,99,0.50))",backdropFilter:"blur(6px)"},chipClass:"px-2 py-1 text-xs font-semibold rounded-full border",chipBlueStyle:{background:"var(--chip-blue-bg, rgba(30,58,138,0.30))",borderColor:"var(--chip-blue-border, rgba(59,130,246,0.50))",color:"var(--chip-blue-text, #93c5fd)"},chipEasyStyle:{background:"var(--chip-easy-bg, rgba(6,78,59,0.30))",borderColor:"var(--chip-easy-border, rgba(16,185,129,0.50))",color:"var(--chip-easy-text, #86efac)"},chipMedStyle:{background:"var(--chip-med-bg, rgba(113,63,18,0.30))",borderColor:"var(--chip-med-border, rgba(234,179,8,0.50))",color:"var(--chip-med-text, #fde68a)"},chipHardStyle:{background:"var(--chip-hard-bg, rgba(127,29,29,0.30))",borderColor:"var(--chip-hard-border, rgba(248,113,113,0.50))",color:"var(--chip-hard-text, #fca5a5)"},btnPrimaryClass:"rounded-lg shadow-lg hover:scale-110 transition-all duration-300",btnPrimaryStyle:{background:"var(--btn-primary, linear-gradient(90deg,#06b6d4,#2563eb))",color:"var(--btn-primary-text, #fff)"}},it={python:"Python",java:"Java",cpp:"C++"},oe=v=>it[v]??v.toUpperCase();function At(){const{auth:v}=We().props;v==null||v.user;const[ie,ne]=i.useState([]),[c,X]=i.useState(null),[_e,ce]=i.useState(!0),[nt,de]=i.useState(!0),[q,ct]=i.useState("all"),[C,Ce]=i.useState("all"),[S,Se]=i.useState("all"),[E,Ee]=i.useState(""),[r,D]=i.useState(null),[j,Y]=i.useState(!1),[g,L]=i.useState(""),[A,O]=i.useState(!1),[b,F]=i.useState(0),[R,H]=i.useState(null),[P,G]=i.useState(!1),[h,W]=i.useState(null),[dt,J]=i.useState(!1),[B,me]=i.useState([]),[Le,K]=i.useState(!1),[Ae,Q]=i.useState(!1),[Fe,pe]=i.useState(!1),[Pe,V]=i.useState(!1),[Be,Z]=i.useState(!1),[Me,ue]=i.useState(!1),M=i.useRef(),[Te,xe]=i.useState({});i.useEffect(()=>{j?document.body.classList.add("modal-open"):document.body.classList.remove("modal-open")},[j]),i.useEffect(()=>{m.registerSfx("success","/sounds/correct.mp3"),m.registerSfx("failure","/sounds/failure.mp3"),m.registerSfx("levelup","/sounds/levelup.mp3"),m.registerSfx("click","/sounds/click.mp3"),m.registerSfx("hover","/sounds/hover.mp3"),m.registerSfx("victory","/sounds/victory.mp3"),m.registerSfx("streak","/sounds/streak.mp3"),m.registerSfx("typing","/sounds/typing.mp3")},[]);const ee=t=>Math.floor(t/10)+1,te=t=>10-t%10,fe=t=>t%10/10*100,ge=t=>t%10;i.useEffect(()=>{I(),$(),T()},[q,C,S,E]),i.useEffect(()=>{const t=!!(j&&r);try{window.__modalOpen=t,window.dispatchEvent(new CustomEvent("app:modal",{detail:{open:t}}))}catch{}const s=document.documentElement;return t?s.classList.add("overflow-hidden"):s.classList.remove("overflow-hidden"),()=>s.classList.remove("overflow-hidden")},[j,r]),i.useEffect(()=>{let t;return R&&(t=setInterval(()=>{F(Math.floor((Date.now()-R.getTime())/1e3))},1e3)),()=>{t&&clearInterval(t)}},[R]),i.useEffect(()=>{if(B.length>0){const t=()=>{me(s=>s.map(a=>({...a,x:a.x+a.vx,y:a.y+a.vy,vy:a.vy-.15,life:a.life-1,size:a.size*.99})).filter(a=>a.life>0)),B.length>0&&(M.current=requestAnimationFrame(t))};M.current=requestAnimationFrame(t)}return()=>{M.current&&cancelAnimationFrame(M.current)}},[B.length]);const T=async()=>{try{const t=await w.get("/api/solo/taken");if(t.success){const s=(t.data||[]).reduce((a,n)=>(a[n.challenge_id]=n.status,a),{});xe(s)}}catch(t){console.error("Error fetching taken rows:",t),xe({})}},I=async()=>{try{ce(!0);const t={};q!=="all"&&(t.mode=q),C!=="all"&&(t.language=C),S!=="all"&&(t.difficulty=S),E.trim()&&(t.search=E.trim());const s=await w.get("/api/challenges/solo",t);if(s.success){const a=s.data.data||s.data||[];ne(a)}}catch(t){console.error("Error fetching challenges:",t),ne([])}finally{ce(!1)}},$=async()=>{var t,s,a;try{de(!0);const n=await w.get("/api/me/stats");if(n.success&&n.data){const o=n.data,p=((t=o.totals)==null?void 0:t.xp)||0;let l=[];if(o.completed_challenge_ids&&Array.isArray(o.completed_challenge_ids))l=o.completed_challenge_ids;else if((s=o.solo_stats)!=null&&s.completed_challenge_ids)l=o.solo_stats.completed_challenge_ids;else if(o.attempts){const d=o.attempts.filter(u=>u.is_correct);l=[...new Set(d.map(u=>u.challenge_id))]}else{const d=["completed_challenges","solo_completed_challenges","successful_challenge_ids","completed_solo_challenges"];for(const u of d)if(o[u]&&Array.isArray(o[u])){l=o[u],console.log(`Found completed challenges in field: ${u}`);break}}X({solo_attempts:o.solo_attempts||0,successful_attempts:o.successful_attempts||l.length,total_xp:p,total_stars:((a=o.totals)==null?void 0:a.stars)||0,attempts_today:o.attempts_today||0,current_level:ee(p),xp_to_next_level:te(p),completed_challenge_ids:l,streak:o.streak||0})}}catch(n){console.error("Error fetching user stats:",n),X({solo_attempts:0,successful_attempts:0,total_xp:0,total_stars:0,attempts_today:0,current_level:1,xp_to_next_level:10,completed_challenge_ids:[],streak:0})}finally{de(!1)}},he=(t,s,a="success")=>{const n={success:["#10B981","#34D399","#6EE7B7","#FBBF24","#F59E0B"],levelup:["#8B5CF6","#A78BFA","#C4B5FD","#F59E0B","#FBBF24"],streak:["#EF4444","#F87171","#FCA5A5","#FBBF24","#F59E0B"]},o=[],p=a==="levelup"?25:15;for(let l=0;l<p;l++){const d=Math.PI*2*l/p,u=Math.random()*8+4;o.push({id:Date.now()+l,x:t+(Math.random()-.5)*50,y:s+(Math.random()-.5)*30,vx:Math.cos(d)*u+(Math.random()-.5)*2,vy:Math.sin(d)*u-Math.random()*3,life:80+Math.random()*40,maxLife:80,color:n[a][Math.floor(Math.random()*n[a].length)],size:Math.random()*6+3,type:a})}me(l=>[...l,...o])},Ie=()=>{const t=document.documentElement;t.requestFullscreen?t.requestFullscreen():t.webkitRequestFullscreen?t.webkitRequestFullscreen():t.msRequestFullscreen&&t.msRequestFullscreen()},$e=()=>{var t;document.fullscreenElement&&((t=document.exitFullscreen)==null||t.call(document))},ze=t=>{if(m.play("click"),Ie(),c!=null&&c.completed_challenge_ids.includes(t.id)){m.play("failure"),f.fire({icon:"info",title:"Challenge Already Completed!",text:"You have already solved this challenge. Try a different one!",timer:2e3,showConfirmButton:!1,background:"#1f2937",color:"#fff"});return}D(t),L(t.buggy_code||""),Y(!0),H(new Date),F(0)},be=(t,s)=>{const a=t.length,n=s.length;if(a===0)return n===0?1:0;if(n===0)return 0;const o=Array(n+1).fill(null).map(()=>Array(a+1).fill(null));for(let l=0;l<=a;l++)o[0][l]=l;for(let l=0;l<=n;l++)o[l][0]=l;for(let l=1;l<=n;l++)for(let d=1;d<=a;d++)t[d-1]===s[l-1]?o[l][d]=o[l-1][d-1]:o[l][d]=Math.min(o[l-1][d]+1,o[l][d-1]+1,o[l-1][d-1]+1);const p=Math.max(a,n);return(p-o[n][a])/p},Ue=(t,s)=>{var k,_;const a=t.trim(),n=(k=s.fixed_code)==null?void 0:k.trim();if(!a)return console.log("Code validation: FAIL - No code provided"),!1;if(!n)return console.log("Code validation: FAIL - No solution available in database"),!1;if(a===((_=s.buggy_code)==null?void 0:_.trim()))return console.log("Code validation: FAIL - No changes made from original buggy code"),!1;const o=se=>se.replace(/\r\n/g,`
`).replace(/\s+/g," ").replace(/\s*;\s*/g,";").replace(/\s*\{\s*/g,"{").replace(/\s*\}\s*/g,"}").replace(/\s*\(\s*/g,"(").replace(/\s*\)\s*/g,")").replace(/\s*==\s*/g,"==").replace(/\s*=\s*/g,"=").trim(),p=o(a),l=o(n);if(p===l)return console.log("Code validation: PASS - Exact match with database solution (100%)"),!0;const u=be(p,l),y=Math.round(u*100);console.log(`Code validation: FAIL - Only ${y}% similarity with database solution (requires 100%)`);const N=u>=1;return console.log(`Code validation: ${N?"PASS":"FAIL"} (${y}% similarity, requires 100%)`),N},Xe=async()=>{var t;if(!r||!g.trim()){m.play("failure"),f.fire("Error","Please write some code before submitting.","error");return}try{if(O(!0),m.play("typing"),!r.fixed_code){m.play("failure"),f.fire("Error","This challenge does not have a solution stored in the database.","error"),O(!1);return}const s=Ue(g,r),a=be(g.trim().replace(/\s+/g," "),r.fixed_code.trim().replace(/\s+/g," "));W({isCorrect:s,similarity:a}),G(!0);const n={challenge_id:r.id,language:r.language,mode:r.mode,time_spent_sec:b,is_correct:s,code_submitted:g,judge_feedback:s?"Perfect! Your solution is an exact match with the expected answer from database (100% match).":`Incorrect. Your solution has ${Math.round(a*100)}% similarity with the expected answer. You need 100% match to pass. Try again or view the correct answer.`},o=await w.post("/api/solo/attempts",n);if(o.success){const p=((t=o.data)==null?void 0:t.xp_earned)||(s?r.reward_xp:0);if(s){await w.post("/api/solo/mark-taken",{challenge_id:r.id,language:r.language,difficulty:r.difficulty,mode:r.mode,status:"completed",time_spent_sec:b,code_submitted:g,earned_xp:p??0});const l=(c==null?void 0:c.total_xp)||0,d=l+p,u=ee(l),y=ee(d),N=y>u;c&&!c.completed_challenge_ids.includes(r.id)&&X(U=>U?{...U,completed_challenge_ids:[...U.completed_challenge_ids,r.id],successful_attempts:U.successful_attempts+1,total_xp:d,current_level:y,xp_to_next_level:te(d)}:null),m.play("success"),Q(!0),V(!0),Z(!0),ue(!0),setTimeout(()=>ue(!1),2e3);const k=window.innerWidth/2,_=window.innerHeight/2;he(k,_,"success"),N&&setTimeout(()=>{m.play("levelup"),K(!0),he(k,_-100,"levelup")},1e3),setTimeout(()=>{m.play("victory")},500);const{isConfirmed:se}=await f.fire({title:"PERFECT SOLUTION!",html:`
  ...
  `,showConfirmButton:!0,confirmButtonText:"Continue Coding!",confirmButtonColor:"#10B981",background:"linear-gradient(135deg, #1e3a8a 0%, #312e81 100%)",color:"#fff",allowOutsideClick:!1,allowEscapeKey:!1});se&&(Q(!1),V(!1),K(!1),Z(!1),Y(!1),D(null),L(""),H(null),F(0),G(!1),W(null),J(!1),await Promise.all([I(),$(),T()])),setTimeout(()=>{Q(!1),V(!1),K(!1),Z(!1)},7e3)}else m.play("failure"),pe(!0),setTimeout(()=>pe(!1),600),await f.fire({title:"Almost There!",html:`
                            <div class="text-center">
                        ...
                        `,timer:4500,showConfirmButton:!0,confirmButtonText:"Try Again",background:"linear-gradient(135deg, #1e3a8a 0%, #312e81 100%)",color:"#fff",confirmButtonColor:"#3B82F6"});await Promise.all([$(),I()]),await T()}else throw new Error(o.message||"Submission failed")}catch(s){console.error("Error submitting attempt:",s),m.play("failure");let a="Failed to submit your attempt. Please try again.";s instanceof Error&&(a=s.message),f.fire("Error",a,"error")}finally{O(!1)}},ye=async t=>{try{if(r){const s={challenge_id:r.id,language:r.language,difficulty:r.difficulty,mode:r.mode,status:t,time_spent_sec:b,code_submitted:g||r.buggy_code||"",earned_xp:t==="completed"?r.reward_xp??0:0};await w.post("/api/solo/mark-taken",s),console.log(`Challenge marked as ${t} in database`)}}catch(s){console.error("Error marking challenge as taken:",s),f.fire({title:"Warning",text:"Progress may not have been saved properly.",icon:"warning",timer:1500,showConfirmButton:!1,background:"#1f2937",color:"#fff"})}finally{m.play("click"),Y(!1),D(null),L(""),H(null),F(0),G(!1),W(null),J(!1),$e(),await I(),await $(),await T()}},qe=async()=>{try{if(!r)return;const t=r.fixed_code;r&&g.trim()!==(r.buggy_code??"").trim()||b>0?await ye("abandoned"):await ye("abandoned"),t&&t.trim().length>0?Ge("Correct Answer",t):f.fire({icon:"info",title:"No Stored Solution",text:"This challenge has no fixed solution saved in the database.",background:"#1f2937",color:"#fff",confirmButtonColor:"#10B981"})}catch(t){console.error("quitAndShowSolution error:",t)}},De=()=>{r!=null&&r.fixed_code&&(m.play("click"),J(!0),f.fire({title:`
...
${r.fixed_code}
          ...
          <div class="mt-5 flex items-center justify-between text-xs text-gray-400 italic">
            <span>💻 Language: ${oe(r.language)}</span>
            <span>🎯 Difficulty: ${r.difficulty.toUpperCase()}</span>
          </div>
      ...
      `,background:"linear-gradient(135deg, #111827 0%, #1e293b 100%)",color:"#fff",confirmButtonText:"Got it!",confirmButtonColor:"#10B981",width:"700px",customClass:{popup:"animate-fadeInUp shadow-2xl border border-cyan-600/30 rounded-2xl backdrop-blur-lg"},didOpen:()=>{var s;const t=(s=f.getHtmlContainer())==null?void 0:s.querySelector("pre");t&&(t.textContent=r.fixed_code)}}))},Ye=t=>{switch(t){case"easy":return x.chipEasyStyle;case"medium":return x.chipMedStyle;case"hard":return x.chipHardStyle;default:return x.chipBlueStyle}},Oe=t=>t==="fixbugs"?rt:lt,ve=t=>t==="fixbugs"?"text-yellow-400":"text-purple-400",Re=t=>{const s=Math.floor(t/60),a=t%60;return`${s}:${a.toString().padStart(2,"0")}`},He=new Set(["completed","abandoned"]),ae=ie.filter(t=>{const s=c==null?void 0:c.completed_challenge_ids.includes(t.id),a=Te[t.id];return!(s||a&&He.has(a))}),z=({title:t,value:s,icon:a,color:n,animated:o=!1})=>e.jsx("div",{className:`
                bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-4 
                ${o?"animate-pulse glow-effect":""} 
                hover:scale-105 hover:shadow-xl transition-all duration-300 
                ${Be?"glow-success":""}
                cursor-pointer
            `,onMouseEnter:()=>m.play("hover"),children:e.jsxs("div",{className:"flex items-center space-x-3",children:[e.jsx("div",{className:`p-2 rounded-lg ${n} transition-all duration-300`,children:e.jsx(a,{className:"h-5 w-5 text-white"})}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs text-gray-400",children:t}),e.jsx("p",{className:"text-lg font-bold text-white",children:s})]})]})}),Ge=(t,s)=>{f.fire({title:t,html:`
      <div>
