...
const handleLogout = async () => {
  ...
  const QuickShortcutDock = () => (
   <aside className={[
      "quick-dock fixed left-0 top-0 bottom-0 z-30 hidden lg:flex bg-slate-950/60 backdrop-blur-md border-r border-slate-800/70 shadow-xl w-14 overflow-y-auto overflow-x-hidden overscroll-contain",
