...
export default function ParticipantPractice() {
    ...
    useEffect(() => {
        const sounds = {
            ...
            failure: new Audio('/sounds/incorrect.mp3'),
    ...
    const playSound = (name: keyof typeof audioRef.current) => {
            ...
            <AppLayout breadcrumbs={breadcrumbs}>
                ...
                <div className="flex flex-col gap-6 p-4 relative z-10">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            onClick={toggleSound}
                            className={`p-2 rounded-lg ${soundEnabled ? 'bg-green-600 text-white' : 'bg-gray-600 text-gray-300'}`}
                        >
                            ...
                            <div className="bg-gray-800/50 rounded-xl p-6">
                                ...
                                <div className="mt-4">
                                    <div className="flex justify-between text-sm text-gray-400 mb-2">
                                        ...
                                        <span>{filteredQuestions.length > 0 ? Math.round(((currentQuestionIndex + 1) / filteredQuestions.length) * 100) : 0}%</span>
                                    </div>
                                    <div className="w-full bg-gray-700 rounded-full h-2">
                                        <div 
                                            className="bg-gradient-to-r from-blue-500 to-purple-600 h-2 rounded-full transition-all duration-300"
                                            style={{ width: `${filteredQuestions.length > 0 ? ((currentQuestionIndex + 1) / filteredQuestions.length) * 100 : 0}%` }}
                                        ></div>
                                    </div>
                                </div>
                            </div>
